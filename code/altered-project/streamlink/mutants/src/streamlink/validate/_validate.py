...
class Schema(AllSchema):
    ...
    def xǁSchemaǁvalidate__mutmut_orig(self, value: Any, name: str = "result", exception: type[Exception] = PluginError) -> Any:
        try:
    ...
    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_1(self, value: Any, name: str = "XXresultXX", exception: type[Exception] = PluginError) -> Any:
        try:
            return validate(self, value)
        except ValidationError as err:
            raise exception(f"Unable to validate {name}: {err}") from None
    ...
    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_2(self, value: Any, name: str = "RESULT", exception: type[Exception] = PluginError) -> Any:
        try:
            return validate(self, value)
        except ValidationError as err:
            raise exception(f"Unable to validate {name}: {err}") from None
    ...
    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_3(self, value: Any, name: str = "Result", exception: type[Exception] = PluginError) -> Any:
        try:
            return validate(self, value)
        except ValidationError as err:
            raise exception(f"Unable to validate {name}: {err}") from None
    ...
    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_4(self, value: Any, name: str = "result", exception: type[Exception] = PluginError) -> Any:
        try:
            return validate(None, value)
        except ValidationError as err:
            raise exception(f"Unable to validate {name}: {err}") from None

    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_5(self, value: Any, name: str = "result", exception: type[Exception] = PluginError) -> Any:
        try:
            return validate(self, None)
        except ValidationError as err:
            raise exception(f"Unable to validate {name}: {err}") from None

    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_6(self, value: Any, name: str = "result", exception: type[Exception] = PluginError) -> Any:
        try:
    ...
    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_7(self, value: Any, name: str = "result", exception: type[Exception] = PluginError) -> Any:
        try:
    ...
    # TODO: replace default PluginError exception
    def xǁSchemaǁvalidate__mutmut_8(self, value: Any, name: str = "result", exception: type[Exception] = PluginError) -> Any:
        try:
            return validate(self, value)
        except ValidationError as err:
            raise exception(None) from None
    
    xǁSchemaǁvalidate__mutmut_mutants : ClassVar[MutantDict] = {
    'xǁSchemaǁvalidate__mutmut_1': xǁSchemaǁvalidate__mutmut_1, 
        'xǁSchemaǁvalidate__mutmut_2': xǁSchemaǁvalidate__mutmut_2, 
        'xǁSchemaǁvalidate__mutmut_3': xǁSchemaǁvalidate__mutmut_3, 
        'xǁSchemaǁvalidate__mutmut_4': xǁSchemaǁvalidate__mutmut_4, 
        'xǁSchemaǁvalidate__mutmut_5': xǁSchemaǁvalidate__mutmut_5, 
        'xǁSchemaǁvalidate__mutmut_6': xǁSchemaǁvalidate__mutmut_6, 
        'xǁSchemaǁvalidate__mutmut_7': xǁSchemaǁvalidate__mutmut_7, 
        'xǁSchemaǁvalidate__mutmut_8': xǁSchemaǁvalidate__mutmut_8
    }
    
    def validate(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁSchemaǁvalidate__mutmut_orig"), object.__getattribute__(self, "xǁSchemaǁvalidate__mutmut_mutants"), args, kwargs, self)
        return result 
    
    validate.__signature__ = _mutmut_signature(xǁSchemaǁvalidate__mutmut_orig)
    xǁSchemaǁvalidate__mutmut_orig.__name__ = 'xǁSchemaǁvalidate'
