...
class KickAdapter(SSLContextAdapter):
    def xǁKickAdapterǁget_ssl_context__mutmut_orig(self):
        ctx = super().get_ssl_context()
        ctx.options &= ~OP_NO_TICKET

        return ctx
    def xǁKickAdapterǁget_ssl_context__mutmut_1(self):
        ctx = None
        ctx.options &= ~OP_NO_TICKET

        return ctx
    def xǁKickAdapterǁget_ssl_context__mutmut_2(self):
        ctx = super().get_ssl_context()
        ctx.options = ~OP_NO_TICKET

        return ctx
    def xǁKickAdapterǁget_ssl_context__mutmut_3(self):
        ctx = super().get_ssl_context()
        ctx.options |= ~OP_NO_TICKET

        return ctx
    def xǁKickAdapterǁget_ssl_context__mutmut_4(self):
        ctx = super().get_ssl_context()
        ctx.options &= OP_NO_TICKET

        return ctx
    
    xǁKickAdapterǁget_ssl_context__mutmut_mutants : ClassVar[MutantDict] = {
    'xǁKickAdapterǁget_ssl_context__mutmut_1': xǁKickAdapterǁget_ssl_context__mutmut_1, 
        'xǁKickAdapterǁget_ssl_context__mutmut_2': xǁKickAdapterǁget_ssl_context__mutmut_2, 
        'xǁKickAdapterǁget_ssl_context__mutmut_3': xǁKickAdapterǁget_ssl_context__mutmut_3, 
        'xǁKickAdapterǁget_ssl_context__mutmut_4': xǁKickAdapterǁget_ssl_context__mutmut_4
    }
    
    def get_ssl_context(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁKickAdapterǁget_ssl_context__mutmut_orig"), object.__getattribute__(self, "xǁKickAdapterǁget_ssl_context__mutmut_mutants"), args, kwargs, self)
        return result 
    
    get_ssl_context.__signature__ = _mutmut_signature(xǁKickAdapterǁget_ssl_context__mutmut_orig)
    xǁKickAdapterǁget_ssl_context__mutmut_orig.__name__ = 'xǁKickAdapterǁget_ssl_context'
