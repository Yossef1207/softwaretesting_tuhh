...
class PlutoHLSStreamWriter(HLSStreamWriter):
    ...
    def xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_orig(self, segment):
        return self.ad_re.search(segment.uri) is not None or super().should_filter_segment(segment)

    def xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_1(self, segment):
        return self.ad_re.search(None) is not None or super().should_filter_segment(segment)

    def xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_2(self, segment):
        return self.ad_re.search(segment.uri) is None or super().should_filter_segment(segment)

    def xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_3(self, segment):
        return self.ad_re.search(segment.uri) is not None and super().should_filter_segment(segment)

    def xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_4(self, segment):
        return self.ad_re.search(segment.uri) is not None or super().should_filter_segment(None)
    
    xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_mutants : ClassVar[MutantDict] = {
    'xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_1': xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_1, 
        'xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_2': xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_2, 
        'xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_3': xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_3, 
        'xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_4': xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_4
    }
    
    def should_filter_segment(self, *args, **kwargs):
        result = _mutmut_trampoline(object.__getattribute__(self, "xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_orig"), object.__getattribute__(self, "xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_mutants"), args, kwargs, self)
        return result 
    
    should_filter_segment.__signature__ = _mutmut_signature(xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_orig)
    xǁPlutoHLSStreamWriterǁshould_filter_segment__mutmut_orig.__name__ = 'xǁPlutoHLSStreamWriterǁshould_filter_segment'
